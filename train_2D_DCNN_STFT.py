...
if __name__ == '__main__':
  ...
  # embed()
  model.summary()
  checkpoints_path = os.path.join('checkpoints', 'Conv2D_spec')
  ...
  print(os.path.join(checkpoints_path,'ep-015-vl-0.2159.hdf5'))
  #model1 = loadmodel()
  #print('ep-{epoch:03d}-vl-{val_accuracy:.4f}.hdf5')
  model.load_weights(os.path.join(checkpoints_path,'ep-015-vl-0.2159.hdf5'))
  model.fit_generator(
      train_gen,
